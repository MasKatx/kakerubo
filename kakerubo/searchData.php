		...
		<div id="contents">
			...
			<div class="inner">
				...
				<section>
					...
					<h2>SEARCH<span>家計簿データの検索</span></h2>
					<form method="POST" action="searchedResultData.php">
						<table class="ta1">
							<tr>
								<th>収支</th>
								<td>
									<input type="radio" name="in_out" value="in">
									<label for="in">収入</label><br>
									<input type="radio" name="in_out" value="out">
									<label for="out">支出</label><br>
                                    <input type="radio" name="in_out" value="both" checked>
									<label for="both">収支どちらも</label>
								</td>
							</tr>
							<tr>
								<th>費目</th>
							...
							<tr>
								<th>年月日</th>
								<td>
                                    <input type="date" name="datesStart" size="30" class="ws"> から
                                    <input type="date" name="datesEnd" size="30" class="ws"> まで
                                </td>
							</tr>
						</table>
