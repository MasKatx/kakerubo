		...
		<div id="contents">
			...
			<div class="inner">
				...
				<section>
					...
					<!-- データの入力 -->
					<h2>EDIT<span>家計簿データの編集</span></h2>
					<form method="POST" action="editResultData.php" style="text-align:center;">
						<p class="c">データのIDを入力してください</p><input type="number" name="ID" required>
						<p class="c">
