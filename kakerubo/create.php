...
<head>
	...
	<title>家計簿管理サイト|kakerubo-新規作成</title>
		...
		<div id="contents">
			...
			<div class="inner">
				...
				<section>
					...
					<h2>CREATE<span>家計簿の新規作成</span></h2>
					<form method="POST" action="<?php echo es($_SERVER['PHP_SELF']); ?>">
						<?php
						// 全て正しく入力されていたら、DB作成用PHPページに移行
							if(isSet($_POST["name"]) && isSet($_POST["password"]) && isSet($_POST["checkPassword"])){
								if($_POST["name"] != "" && $_POST["password"] != "" && $_POST["checkPassword"] != ""){
									...
									echo "<p class='c' style='color:#FF5555'>全てのフィールドに入力してください</p>";
								}
						...
						<table class="ta1">
							...
							<tr>
								<th>パスワード:8~20字</th>
								<td><input type="password" name="password" size="30" class="ws" oncopy="return false" onpaste="return false" oncontextmenu="return false" minlength="8" maxlength="20"></td>
							</tr>
							<tr>
								<th>パスワード(確認)</th>
								<td><input type="password" name="checkPassword" size="30" class="ws" oncopy="return false" onpaste="return false" oncontextmenu="return false" minlength="8" maxlength="20"></td>
							</tr>
						</table>
